...
# configurations
img_folder = '/raid/yhliu/DATA/DIV2K/DIV2K_train_png/LR/x4/*'  # glob matching pattern
lmdb_save_path = '/raid/yhliu/DATA/DIV2K/DIV2K_train_sub_LR.lmdb'
meta_info = {'name': 'DIV2K800_sub_LR'}
