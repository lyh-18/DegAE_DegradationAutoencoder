...
class DDGTestDataset(data.Dataset):
    def __init__(self, opt):
        super(DDGTestDataset, self).__init__()
        self.opt = opt
    ...
    def __getitem__(self, index):
        ...
        clean_prob, blur_prob, gaussian_prob, poisson_prob, speckle_prob, jpeg_prob = 0.3, 0.5, 0.5, 0.0, 0.0, 0.0
        ...
        return {'LQ1': img_LQ1, 'LQ2': img_LQ2, 'HQ1': img_HQ1, 'HQ2': img_HQ2, 
                'HQ1_path': HQ1_path, 'HQ2_path': HQ2_path, 'HQ_path': HQ1_path,
