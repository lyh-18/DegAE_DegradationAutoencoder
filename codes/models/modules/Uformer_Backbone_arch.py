...
class Uformer_Backbone(nn.Module):
    def __init__(self, img_size=256, in_chans=3, dd_in=3, out_chans=64,
...
if __name__ == "__main__":
    ...
    model_restoration = Uformer_Backbone(img_size=input_size, embed_dim=32, depths=depths, out_chans=64,
    ...
    y = model_restoration(rgb_noisy)
    y = torch.masked_select(y, mask.bool()).reshape(1,64,H,W)
    print(y.shape)
