...
class SwinIR_Backbone(nn.Module):
    def __init__(self, img_size=64, patch_size=1, in_chans=3,
                 ...
                 global_residual=False, return_fea=None,
                 **kwargs):
        super(SwinIR_Backbone, self).__init__()
        num_in_ch = in_chans
        num_out_ch = in_chans
        num_feat = 64
...
if __name__ == '__main__':
    ...
    model_encoder = SwinIR_Backbone(img_size=(height, width),
    ...
    total_params = sum(p.numel() for p in model_encoder.parameters())
